...
pub fn get_issue_url(logs: String) -> String {
    ...
    format!("https://github.com/kikyo2006/aurascribe/issues/new?assignees=kikyo2006&labels=bug&projects=&template=bug_report.yaml&title=App+reports+bug&logs={}", urlencoding::encode(&format!("{}\n\n{}", extra_info, &logs)))
}
